...
export const DropOffParkingOptions = (): JSX.Element => {
	...
	const handleOnClick = (evt: MouseEvent<HTMLButtonElement>) => {
		const btnValue = evt.currentTarget.getAttribute('data-drop-val');
		...
		<li className={styles.parking}>
			...
			<div className={styles.btns}>
				<button
					...
					data-drop-val={ParkingAvailability.NO}
				...
				<button
					...
					data-drop-val={ParkingAvailability.SPACE_OUTSIDE}
				...
				<button
					...
					data-drop-val={ParkingAvailability.ON_STREET}
				...
				<button
					...
					data-drop-val={ParkingAvailability.NEARBY}
