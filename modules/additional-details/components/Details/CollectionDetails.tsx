...
type Props = {
	fieldErrors: {
		collectionFullNameError?: string;
		collectionEmailError?: string;
		collectionPhoneError?: string;
	};
...
export const CollectionDetails = ({
	register,
	fieldErrors: {
		collectionFullNameError,
		collectionEmailError,
		collectionPhoneError
	},
	control,
	customerDetails,
	isVisible,
	...
	return (
		<div className={styles.items}>
			<div className={styles.heading}>
				<h3 className={styles.title}>Collection Details</h3>
			...
			<div className="grid grid-cols-1 xs:grid-cols-3 gap-2">
				...
				<Controller
					...
					render={({ field: { ref, ...field } }) => (
						<PhoneNumberInput
							{...field}
							phoneError={collectionPhoneError}
							value={
								isVisible ? (phone as string) : (field.value as number | string)
							}
							onChange={field.onChange}
							inputClass="!input !h-10 !bg-stone-500 shadow-none !rounded-full !border-0 !w-full font-normal"
						/>
					)}
				/>
			</div>
